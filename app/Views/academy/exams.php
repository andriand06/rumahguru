...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item " href="/academy/my" selected>Kelas</a>
            <a class="collapse-item active" href="/academy/exams">Exam</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><img src="<?= base_url('/assets/img/buku.png');?>" alt=""> Exams</h1>
                   
                    </div>
                    <p>Exams</p>
                    <div class="kontainer putih mt-3">
                        <h5>Daftar Ujian yang diikuti</h5>
                        <table class="table">
                            <thead>
                                <tr>
