    ...
    <div id="content">
        ...
        <?php endif   ; ?>
            ...
            <div class="kontainer putih mt-3">
                ...
                <form action="/admin/updatekelas/<?= $kelas['id']; ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field()   ; ?>
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <input type="file"  class="form-control <?//= ($val->hasError('id')) ? 'is-invalid' : '' ;?>" id="gambar" name="gambar" value="<?= $kelas['gambar']; ?>" >
                        <div class="invalid-feedback" style="color:red">
                            <?//= $val->getError('id')   ; ?>
                        </div>
                     </div>
